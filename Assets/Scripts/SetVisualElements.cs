...
public class SetVisualElements : MonoBehaviour {
	...
	private void getTips()
	{
		...
		Tips.Add ("Reducir: Se trata de evitar todas las acciones que generen desperdicios y basura innecesariamente.");
		...
		Tips.Add ("Una buena práctica para la conservación de la energía, es apagando la luz cuando no la necesite.");
		Tips.Add ("Una buena práctica para la conservación de la energía, es utilizar la luz del día en vez de una bombilla.");
		Tips.Add ("Una buena práctica para la conservación de la energía, es apagando el aire acondicionado cuando no se necesite.");
		Tips.Add ("Una buena práctica para la conservación de la energía, es apagando el televisor cuando no esté en uso.");
		Tips.Add ("Una buena práctica para la conservación de la energía, es desconectando todos los enchufes cuando no este usando los aparatos.");
		Tips.Add ("Una buena práctica para la conservación de la energía, es utilizando bombillo de menos consumo eléctrico como las LED.");
		...
		Tips.Add ("Una forma de contaminación es la del agua, ejemplo de esto sería la tira de basura, desechos químicos de fábricas, derramamiento de petreolo, etc...");
		...
		Tips.Add ("Hay que cuidar nuestros parque nacionales, evitando acciones como tirar basura, alimentar sin permiso a los animales, tocar los animales o las plantas.");
